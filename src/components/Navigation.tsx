      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button
              onClick={generatePDF}
              className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg font-semibold flex items-center gap-2 transition-all duration-300 hover:scale-105 shadow-lg"
            >
              <Download size={16} />
              Resume
            </button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="md:hidden flex items-center space-x-2">
              ...
              <button
                onClick={generatePDF}
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-2 py-1 rounded text-xs font-semibold flex items-center gap-1 transition-all duration-300"
              >
                <Download size={12} />
                CV
              </button>
